...
use App\Http\Requests\Booking\ApproveBookingManagerRequest;
use App\Services\BookingService;
use Illuminate\Database\Eloquent\ModelNotFoundException;
use Illuminate\Validation\ValidationException;

class ApproveBookingManagerController extends Controller
{
    /**
     * 
     * @var BookingService
    ...
    /**
     * 
     * ApproveBookingManagerController constructor
     * 
     * @return void
     */
    ...
    {
        // Authorization
        $this->middleware('can:approve-booking-manager')->only(['update']);
     ...
     *
     * @param  \App\Http\Requests\Booking\ApproveBookingManagerRequest  $request
     * @param  int  $id
     * @return \Illuminate\Http\Response
     */
    public function update(ApproveBookingManagerRequest $request, $id)
    {
        try
        {
            $request->validated();
