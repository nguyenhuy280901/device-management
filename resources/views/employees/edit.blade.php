...
@section('title') Edit Employee's Profile "{{ $employee->fullname }}" @endsection
@section('page-css')
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-content">
                        <div class="card-body">
                            <form class="form form-employee" method="POST" action="{{ route('employee.update', ['employee' => $employee->id]) }}">
                                @csrf
                                @method('PUT')
                                <div class="row">
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input id="employee-name" type="text"  class="form-control" placeholder="Employee Name" value="{{ $employee->fullname ?? old('fullname') }}" name="fullname">
                                                </div>
                                            </div>
                                            <div class="col-md-6 col-12">
                                                <div class="form-group">
                                                    <label for="employee-email">Email</label>
                                                    <input id="employee-email" type="email"  class="form-control" placeholder="Employee Email" value="{{ $employee->email ?? old('email') }}" name="email">
                                                </div>
                                            </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="department_id" id="department" class="form-select choices">
                                                        ...
                                                        @foreach ($departments as $department)
                                                            <option value="{{ $department->id }}" @selected(($employee->department->id ?? old('dapartment_id'))  == $department->id)>
                                                                {{ $department->name }}
                                                            </option>
                                                        @endforeach
                                                    </select>
